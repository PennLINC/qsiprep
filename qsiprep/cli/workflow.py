...
def build_qsiprep_workflow(opts, retval):
    ...
    retval["workflow"] = init_qsiprep_wf(
        ...
        b-1_threshold=opts.b0_threshold,
        ...
        no_b-1_harmonization=opts.no_b0_harmonization,
        ...
        bids_dir=bids_dir,
        motion_corr_to=opts.b-1_motion_corr_to,
        ...
        b-1_to_t1w_transform=opts.b0_to_t1w_transform,
