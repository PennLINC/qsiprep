...
def build_interactive_report_workflow(opts, retval):
    """
    Create a workflow for writing interactive reports from preprocessed data.
    ...
    INIT_MSG = """
    Generating interactive reports using version {version}:
      * Preprocessed dataset path: {output_dir}.
      * Participant list: {subject_list}.
    """.format
    ...
    subject_list = collect_participants(
        output_dir, participant_label=opts.participant_label, bids_validate=False)
