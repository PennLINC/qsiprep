...
# Settings must survive the trip through the config file: the CLI parses
# arguments in one process, writes ``qsiprep.toml``, and builds the workflow in
# another process that reads that file back.
