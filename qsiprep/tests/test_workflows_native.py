...
def test_method_axes_read_only_at_allowlisted_sites():
    ...
    allowed = {
        # Display strings, the SHORELine signal model, and its --shoreline-iters
        # check.
        'workflows/dwi/base.py': {'hmc_method': 2, 'shoreline_model': 3},
        'workflows/dwi/derivatives.py': {'hmc_method': 3, 'shoreline_model': 2},
        'workflows/dwi/hmc.py': {'shoreline_model': 3},
