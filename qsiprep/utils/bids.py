...
def load_sidecar(path):
    """Load the metadata that applies to a BIDS file, honoring the inheritance principle.

    All applicable JSON sidecars are merged key by key, with the most specific
    ...
    """
    metadata = {}
    for sidecar in find_associated_files(path, '.json'):
