...
def init_ica_aroma_wf(template, metadata, mem_gb, omp_nthreads,
    ...
    before or after denoising `here <http://nbviewer.jupyter.org/github/pennbbl/\
    qsiprep-notebooks/blob/922e436429b879271fa13e76767a6e73443e74d9/issue-817_\
    ...
    .. workflow::
        ...
        from qsiprep.workflows.bold.confounds import init_ica_aroma_wf
    ...
    **Parameters**
        ...
        template : str
            ...
            :py:func:`~qsiprep.workflows.bold.registration.init_bold_reg_wf`.
            The template must be one of the MNI templates (qsiprep uses
