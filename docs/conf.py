...
latex_documents = [
    (master_doc, 'qsiprep.tex', u'qsiprep Documentation',
     author,
     'manual'),
]
...
man_pages = [
    (master_doc, 'qsiprep', u'qsiprep Documentation',
     [author], 1)
]
...
texinfo_documents = [
    (master_doc, 'qsiprep', u'qsiprep Documentation',
     author, 'qsiprep', 'One line description of project.',
     'Miscellaneous'),
]
...
linkcode_resolve = make_linkcode_resolve('qsiprep',
                                         u'https://github.com/pennbbl/'
                                         'qsiprep/blob/{revision}/'
